...
In order to use the same translation workflow as the [Netcash Core GUI](https://github.com/netcash-project/netcash-gui), they use Qt Linguist translation files.  However, to avoid the dependencies on Qt this normally implies, they use a custom loader to read those files at runtime.
...
To test a translation:
    ...
    LANG=es ./build/release/bin/netcash-wallet-cli
